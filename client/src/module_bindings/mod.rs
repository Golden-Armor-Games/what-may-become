...
pub mod create_hero_reducer;
pub mod hero_table;
pub mod hero_type;
pub mod keep_table;
pub mod keep_type;
pub mod move_hero_reducer;
...
pub use create_hero_reducer::{create_hero, set_flags_for_create_hero, CreateHeroCallbackId};
pub use hero_table::*;
pub use hero_type::Hero;
pub use keep_table::*;
pub use keep_type::Keep;
pub use move_hero_reducer::{move_hero, set_flags_for_move_hero, MoveHeroCallbackId};
...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
            Reducer::CreateHero { .. } => "create_hero",
            Reducer::MoveHero { .. } => "move_hero",
...
impl TryFrom<__ws::ReducerCallInfo<__ws::BsatnFormat>> for Reducer {
    ...
    fn try_from(value: __ws::ReducerCallInfo<__ws::BsatnFormat>) -> __sdk::Result<Self> {
        match &value.reducer_name[..] {
            "create_hero" => Ok(
                __sdk::parse_reducer_args::<create_hero_reducer::CreateHeroArgs>(
                    "create_hero",
                    &value.args,
                )?
                .into(),
            ...
            "move_hero" => Ok(
                __sdk::parse_reducer_args::<move_hero_reducer::MoveHeroArgs>(
                    "move_hero",
                    &value.args,
                )?
                .into(),
...
pub struct DbUpdate {
    ...
    keep: __sdk::TableUpdate<Keep>,
    player: __sdk::TableUpdate<Player>,
    town: __sdk::TableUpdate<Town>,
}
    ...
    fn try_from(raw: __ws::DatabaseUpdate<__ws::BsatnFormat>) -> Result<Self, Self::Error> {
        ...
        for table_update in raw.tables {
            match &table_update.table_name[..] {
                ...
                "keep" => db_update
                    .keep
                    .append(keep_table::parse_table_update(table_update)?),
                "player" => db_update
                    .player
                    .append(player_table::parse_table_update(table_update)?),
                "town" => db_update
                    .town
                    .append(town_table::parse_table_update(table_update)?),
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.keep = cache
            .apply_diff_to_table::<Keep>("keep", &self.keep)
            .with_updates_by_pk(|row| &row.id);
        diff.player = cache
            .apply_diff_to_table::<Player>("player", &self.player)
            .with_updates_by_pk(|row| &row.identity);
        diff.town = cache
            .apply_diff_to_table::<Town>("town", &self.town)
            .with_updates_by_pk(|row| &row.id);
...
pub struct AppliedDiff<'r> {
    ...
    keep: __sdk::TableAppliedDiff<'r, Keep>,
    player: __sdk::TableAppliedDiff<'r, Player>,
    town: __sdk::TableAppliedDiff<'r, Town>,
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(
        ...
        callbacks.invoke_table_row_callbacks::<Keep>("keep", &self.keep, event);
        callbacks.invoke_table_row_callbacks::<Player>("player", &self.player, event);
        callbacks.invoke_table_row_callbacks::<Town>("town", &self.town, event);
    }
}
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        ...
        keep_table::register_table(client_cache);
        player_table::register_table(client_cache);
        town_table::register_table(client_cache);
    }
}
